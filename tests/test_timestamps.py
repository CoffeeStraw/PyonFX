...
def test_from_video_file():
    # Extracted with Aegisub Video --> Save Timecodes Files...
    timestamps_expected = [
        0,
        41,
        83,
    ...
    # For MP4 file, we allow a difference of +- 1
    assert all(
        [
            te - 1 <= tr <= te + 1
            for tr, te in zip(timestamps_result, timestamps_expected)
        ]
    )
