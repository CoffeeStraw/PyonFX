...
def main():
    ...
    subprocess.check_call([
        "ffmpeg",
        "-y",
        "-i", os.path.join(dir_path, "test_video.mp4"),
        "-vcodec", "copy",
    ...
    subprocess.check_call([
        "mkvmerge",
        "--output", os.path.join(dir_path, "mkv_timestamps_not_ms.mkv"),
        "--timestamp-scale", "1000", # 1000 means nanosecond
